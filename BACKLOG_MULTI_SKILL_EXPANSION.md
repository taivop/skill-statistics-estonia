...
| 5 | [Elering Dashboard](https://dashboard.elering.ee/) | Energy system time series (electricity/gas balance, price-related context) | Public API endpoints and dashboard datasets | `querying-estonia-energy-data` |
...
| 9 | [Tax and Customs Board statistics/open data](https://www.emta.ee/en/business-client/statistics-and-open-data) | Tax revenue/trade/taxpayer indicators for macro and sector signals | Official stats pages + downloadable data | `querying-estonia-tax-customs-data` |
| 10 | [Estonian Environmental Portal](https://www.keskkonnaportaal.ee/en) | Environmental indicators (air, water, nature) used in policy and ESG analysis | Portal datasets and services | `querying-estonia-environmental-data` |
| 11 | [Estonian Weather Service data feeds](https://www.ilmateenistus.ee/ilma_andmed/xml/forecast.php) | Weather series needed for many explanatory models | Public XML endpoints (forecast/observations) | `querying-estonia-weather-data` |
| 12 | [Health Statistics DB (TAI)](https://statistika.tai.ee/) | Official health outcomes/utilization indicators | Statistical database exports/API-like querying | `querying-estonia-health-statistics` |
...
| 14 | [HaridusSilm](https://www.haridussilm.ee/ee/avaleht) | Education system indicators (schools, outcomes, staffing, geography) | Portal-based query/download flows | `querying-estonia-education-data` |
| 15 | [Transport Administration traffic data](https://www.transpordiamet.ee/liiklussagedus) | Traffic intensity and mobility proxies for economic/transport analyses | Downloadable tables/traffic datasets | `querying-estonia-transport-traffic-data` |
...
| 18 | [Riigi Teataja](https://www.riigiteataja.ee/) | Legal acts corpus for regulation-aware analysis pipelines | Structured legal text search/download endpoints | `querying-estonia-legal-acts-data` |
...
5. `querying-estonia-energy-data` - implemented
...
9. `querying-estonia-tax-customs-data` - implemented
10. `querying-estonia-environmental-data` - implemented
11. `querying-estonia-weather-data` - implemented
12. `querying-estonia-health-statistics` - implemented
13. `using-estonia-health-welfare-open-data` - implemented
14. `querying-estonia-education-data` - implemented
15. `querying-estonia-transport-traffic-data` - implemented
16. `analyzing-estonia-election-results-data` - implemented
17. `querying-riigikogu-open-data` - implemented
18. `querying-estonia-legal-acts-data` - implemented
...
4. `querying-estonia-energy-data`
...
2. `querying-estonia-tax-customs-data`
3. `querying-estonia-environmental-data`
4. `querying-estonia-weather-data`
5. `querying-estonia-health-statistics`
6. `using-estonia-health-welfare-open-data`
7. `querying-estonia-education-data`

### Phase 3 (governance + municipal)

1. `querying-estonia-transport-traffic-data`
2. `analyzing-estonia-election-results-data`
3. `querying-riigikogu-open-data`
4. `querying-estonia-legal-acts-data`
